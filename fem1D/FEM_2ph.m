...
F_w_grav_loc = -weight*N_loc'*density_w*grav_accel*element_size;
...
F_grav_loc = -weight*N_loc'*density_sat*grav_accel*element_size;
...
figure(2);
plot(t,efs(floor(3*n_e/4),:)/total_stress)
%elements(floor(3*n_e/4),:)

figure(3);
plot(t,pp(floor(3*n_e/4),:)/total_stress)
