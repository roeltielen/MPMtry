...
for n=1:n_time_steps-1
    a_v = 0;
    a_f = 1;
    F_internal_1 = F_int*u(:,n);
    F_1 = F_trac + F_grav - F_internal_1;
    v(:,n+1) = v(:,n);
    du = (a_v*v(:,n+1)+(1-a_v)*v(:,n))*t_step;
    u_temp = u(:,n)+du;
    F_internal_2 = F_int*u_temp;
    F_2 = F_trac + F_grav - F_internal_2;
    a = M_lump_inv*(a_f*F_2+(1-a_f)*F_1);
    ...
    clear F_internal_1  F_internal_2 F_1 F_2 du a 
end