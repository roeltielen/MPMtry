...
node_out = floor(number_elements/2+1);
position_out = position_mpm(floor(number_elements/2+1),:);

% %% N(h) for Richardson extrapolation
% % figure(15)
% % plot(t,position_mpm_particles(floor(number_elements*...
% %     number_particles_per_element/2),:))
% % floor(t_check)
