...
% Mesh properties
number_elements = 25; % number of elements
...
[displacement_mpm, velocity_mpm, Mass] = MPM_1D_Linear(density,...
...
Error = norm(displacement_exact(:,floor(t_check))-displacement_mpm(:,floor(t_check)))/sqrt(number_elements*number_particles_per_element)
RMSE = sqrt(mean((displacement_exact(:,floor(t_check))-displacement_mpm(:,floor(t_check))).^2))
