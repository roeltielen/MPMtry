function[u_p, v_p, mass_p] = MPM_1D_Linear(density, E, g, load, H, n_e, h, n_ep,...
 ...
 % OUTPUT: displacement vector, velocity vector for each time step
...
elements_particles(:,:,1) = zeros(n_e,n_p);
 ...
 for i=1:n_e
    for j = (i-1)*n_ep+1:i*n_ep
      elements_particles(i,j) = 1;  %matrix containing the
