...
\centering
 \begin{tabular}{c | c c c}
   & MPM(1) & MPM(4) & MPM(10)\\
   \hline
  4   & -7.4132 $\cdot 10^{-2}$ & -8.0707 $\cdot 10^{-3}$ &-1.1566 $\cdot 10^{-2}$\\
  8   & -4.5493 $\cdot 10^{-2}$ & -1.0011 $\cdot 10^{-2}$ & -5.8929 $\cdot 10^{-3}$\\
  16 & 4.2368  $\cdot 10^{-2}$ & -1.9708 $\cdot 10^{-3}$ & 8.9231 $\cdot 10^{-4}$\\
  32 & & & 4.6725$\cdot 10^{-4}$\\
 \end{tabular}
 \caption{$u_{num}(h)-u_{num}(2h)$ as a function of $h$.}
\end{table}

\begin{tcolorbox}[colback=red!5,colframe=red!50!black,title=Richardson's extrapolation]
The accuracy $\alpha$ is obtained from $$\frac{u_{num}(2h)-u_{num}(4h)}{u_{num}(h)-u_{num}(2h)} = 2^{\alpha}.$$
\end{tcolorbox}
\end{frame}
