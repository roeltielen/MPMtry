...
\begin{frame}{Accuracy: oedometer}
  \begin{minipage}{\linewidth}
    ...
    \hspace{0.01\linewidth}
      ...
      \only<2-3>{
      \centering
      \includegraphics[scale=0.42]{images/accuracy_oedometer_zoomed}
      }
\end{overlayarea}
      \end{minipage}
  \end{minipage}
...
\begin{frame}{FEM: oedometer}
	...
	$k+1$, where $k$ is the order of the interpolating polynomials.
	\end{tcolorbox}
	\pause
...
\begin{thebibliography}{22}
     \bibitem[Gong (1988)]{foo} Gong M. (1998). Bar. \emph{CONF 1988}.
\end{thebibliography}
...
% \bibitem{E} D.~Sulsky, Z.~Chen, H.~L. Schreyer.
% \newblock {\em A Particle method for history-dependent materials}.
% \newblock Computer Methods in Applied Mechanics and Engineering 118, pp. 179-196, 1994.
